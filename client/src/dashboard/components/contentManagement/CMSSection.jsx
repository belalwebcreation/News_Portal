        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="flex w-full items-center justify-between px-6 py-5 hover:bg-slate-50 transition"
            >
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 rounded-xl bg-amber-700 px-5 py-2.5 text-white transition hover:bg-amber-800"
                      >
                        <Settings size={18} />
