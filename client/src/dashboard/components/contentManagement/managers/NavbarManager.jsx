  ...
  return (
    <div className="mx-auto max-w-6xl space-y-4 p-3 sm:space-y-6 sm:p-4">
      <header className="border-b border-slate-200 dark:border-slate-700 pb-4">
        <h2 className="text-xl font-black text-slate-900 dark:text-slate-100 sm:text-2xl">Navbar Manager</h2>
      ...
      <form
        ...
        className="flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 sm:flex-row sm:items-end"
      >
        <div className="min-w-0 flex-1">
          <label htmlFor="nav-category" className="mb-1 block text-xs font-semibold text-slate-600 dark:text-slate-400">
            Category
          </label>
          <select
            id="nav-category"
            ...
            className="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-3 py-2.5 text-sm text-slate-800 dark:text-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
          >
            <option value="">নির্বাচন করুন...</option>
            {filteredCategoryOptions.map((c) => (
              <option key={c._id} value={c._id} className="bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100">
                {c.name}
              </option>
            ))}
          </select>
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-slate-800 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-slate-950 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-800 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
        >
      ...
      <section className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4">
        <div className="mb-3 flex items-center justify-between">
          <h3 className="text-sm font-bold text-slate-800 dark:text-slate-100">Left Menu</h3>
            ...
            {sortedMenus.map((item, index) => (
              <Fragment key={item._id}>
                ...
                <li
                  ...
                  onDrop={handleDrop}
                  className={`flex flex-wrap items-center gap-3 rounded-lg border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/40 p-3 transition-opacity ${
                ...
                >
                  ...
                  <button
                    ...
                    className="cursor-grab touch-none rounded p-0.5 text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 active:cursor-grabbing disabled:opacity-30"
                  ...
                  <div className="flex flex-col">
                    <button
                      ...
                      className="rounded p-0.5 text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 disabled:opacity-30"
                    >
                  ...
                  {item.isHome && editingHome === item._id ? (
                    <div className="flex min-w-0 flex-1 items-center gap-2">
                      <input
                        ...
                        autoFocus
                        className="min-w-0 flex-1 rounded-md border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-2 py-1 text-sm text-slate-800 dark:text-slate-100 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/40"
                      />
                    ...
                    <>
                      ...
                      {item.isHome && (
                        <button
                          ...
                          className="rounded p-1.5 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-800 dark:hover:text-slate-100 transition-colors"
                  ...
                  <div className="ml-auto flex items-center gap-3">
                    ...
                    {!item.isHome && (
                      <button
                        ...
                        className="rounded p-1.5 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 disabled:opacity-40"
                      >
