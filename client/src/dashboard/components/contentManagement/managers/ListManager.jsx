    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
        ...
        <div className="relative w-full lg:w-96">
          ...
          <input
            ...
            placeholder="Search..."
            className="
              w-full h-12 rounded-xl border border-slate-300 pl-12 pr-4 outline-none
        ...
        <button
          onClick={onAdd}
          className="
            h-12 px-6 rounded-xl bg-amber-700 hover:bg-amber-800 text-white
          ...
          <table className="w-full">
            <thead className="bg-slate-100">
              <tr>
                ...
                <th className="px-6 py-4 text-center text-sm font-bold">Position</th>
                <th className="px-6 py-4 text-center text-sm font-bold">Visibility</th>
      ...
      {filteredData.length === 0 && (
        <div className="rounded-2xl border border-dashed border-slate-300 py-16 text-center">
          ...
          <p className="mt-3 text-slate-500">There are no items available in this section.</p>
          <button
            onClick={onAdd}
            className="
              mt-8 h-12 px-6 rounded-xl bg-amber-700 hover:bg-amber-800 text-white
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-t border-slate-200 pt-6">
        <div className="text-sm text-slate-500">
          Total Items : <span className="ml-2 font-bold text-slate-800">{filteredData.length}</span>
        </div>
        <div className="flex items-center gap-2">
          <button disabled className="h-10 px-4 rounded-lg border border-slate-300 text-slate-400 cursor-not-allowed">
            Previous
          </button>
          <button className="h-10 w-10 rounded-lg bg-amber-700 text-white font-semibold">1</button>
          <button disabled className="h-10 px-4 rounded-lg border border-slate-300 text-slate-400 cursor-not-allowed">
            Next
          </button>
        </div>
